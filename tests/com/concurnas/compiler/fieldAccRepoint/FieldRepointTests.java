package com.concurnas.compiler.fieldAccRepoint;
...
public class FieldRepointTests  extends TestCase{
	private final static String SrcDir = (new File("./tests/com/concurnas/compiler/fieldAccRepoint")).getAbsolutePath();
	...
	@Test public void testFieldAccessSandbox() throws Throwable { 
		runCompilation("fieldAccessSandbox"); 
	}
	
	@Test public void testAllFieldAccess() throws Throwable { 
		testBigLoadFiles("testAllFieldAccess");
	}
	...
	private String assertNoPreBytecodeErrors(ArrayList<ErrorHolder> errs, boolean thr)
	{
		if(!errs.isEmpty())
		{
			ArrayList<String> expectedErrs = Utils.erListToStrListNOFN(errs);
