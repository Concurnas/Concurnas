...
x5uncuaghtexceptionsininitanditerator.conc line 6:8 Error when executing initializer for: ThrowsExceptionInit as: java.lang.Exception: unexpected in init~~	at java.base/java.lang.Throwable.init(Throwable.java:270)~~	at java.base/java.lang.Exception.init(Exception.java:66)~~	at com.concurnas.tests.helpers.langExt$ThrowsExceptionInit.initialize(com.concurnas.tests.helpers.langExt.conc:51)~~	at ExtLangLoader$$Init2.apply(ExtLangLoader$$Init2.java)~~	at ExtLangLoader$$Init2.apply(ExtLangLoader$$Init2.java)~~	at java.base/com.concurnas.bootstrap.runtime.cps.IsoCore._runExecute(IsoCore.java:25)~~	at java.base/com.concurnas.bootstrap.runtime.cps.Iso.execute(Iso.java:48)~~	at java.base/com.concurnas.bootstrap.runtime.cps.Worker.run(Worker.java:56)~~
x5uncuaghtexceptionsininitanditerator.conc line 7:8 Error when executing iterator for: ThrowsExceptionIer as: java.lang.Exception: unexpected in iterate~~	at java.base/java.lang.Throwable.init(Throwable.java:270)~~	at java.base/java.lang.Exception.init(Exception.java:66)~~	at com.concurnas.tests.helpers.langExt$ThrowsExceptionIer.iterate(com.concurnas.tests.helpers.langExt.conc:66)~~	at ExtLangLoader$$Iter3.apply(ExtLangLoader$$Iter3.java)~~	at ExtLangLoader$$Iter3.apply(ExtLangLoader$$Iter3.java)~~	at java.base/com.concurnas.bootstrap.runtime.cps.IsoCore._runExecute(IsoCore.java:25)~~	at java.base/com.concurnas.bootstrap.runtime.cps.Iso.execute(Iso.java:48)~~	at java.base/com.concurnas.bootstrap.runtime.cps.Worker.run(Worker.java:56)~~
