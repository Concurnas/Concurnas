...
methods:[$ConcurnasMetaVersion$: [], clinit$: [], clinitOnce$: [], clone: [], compareTo: [], compareTo: [], copy: [], copy: [], defaultFieldInit$: [], delete: [], describeConstable: [], equals: [], fromBinary: [], getA: [@NullStatus(nullable = [])], getDeclaringClass: [], getGlobalDependancies$: [], hashCode: [], init: [@AnnotOneArg(name = ok) @NullStatus(nullable = [])], init: [], init: [], lambda$describeConstable$0: [], metaBinary: [], name: [], ordinal: [], setA: [@NullStatus(nullable = [])], toBinary: [], toBoolean: [], toString: [], valueOf: [], valueOf: [], values: []]
cons: [[@AnnotOneArg(name = ok) @NullStatus(nullable = [])]]
...
[@MyAnnot($ConcurnasMetaVersion$ = Concurnas, getGlobalDependancies$ = []) @Typedefs(typedefs = [@Typedef(accessModifier = public, args = [X], defaultType = , location = x59annotationsareexposableatmodulelevel, name = mylistQ, type = Ljava/util/ArrayList<Ljava/lang/String;>;)])]
