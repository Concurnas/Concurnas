...
[$ConcurnasMetaVersion$:, copy:, copy:, defaultFieldInit$:, equals:@NullStatus(nullable = []), fromBinary:@Uninterruptible, getGlobalDependancies$:, hashCode:@NullStatus(nullable = []), m1:@AnotTakesIntArray(theArg = [1 2 3]), @NullStatus(nullable = []), metaBinary:@Uninterruptible, toBinary:@Uninterruptible]

~~~~~
//##12. annotation array argument empty array
[$ConcurnasMetaVersion$:, copy:, copy:, defaultFieldInit$:, equals:@NullStatus(nullable = []), fromBinary:@Uninterruptible, getGlobalDependancies$:, hashCode:@NullStatus(nullable = []), m1:@AnotTakesIntArray(theArg = []), @NullStatus(nullable = []), metaBinary:@Uninterruptible, toBinary:@Uninterruptible]

~~~~~
//##13. annotation key value
[$ConcurnasMetaVersion$:, copy:, copy:, defaultFieldInit$:, equals:@NullStatus(nullable = []), fromBinary:@Uninterruptible, getGlobalDependancies$:, hashCode:@NullStatus(nullable = []), m1:@AnnotTwoArgOneDefault(name = firstname, name2 = 999), @NullStatus(nullable = []), m2:@AnnotTwoArgOneDefault(name = firstname, name2 = hi), @NullStatus(nullable = []), m3:@AnnotTwoArgAllDefault(name = hi1, name2 = hi2), @NullStatus(nullable = []), metaBinary:@Uninterruptible, toBinary:@Uninterruptible]

~~~~~
//##14. annotation key value more than one
[$ConcurnasMetaVersion$:, copy:, copy:, defaultFieldInit$:, equals:@NullStatus(nullable = []), fromBinary:@Uninterruptible, getGlobalDependancies$:, hashCode:@NullStatus(nullable = []), m1:@AnnotTwoArgOneDefault(name = firstname, name2 = 999), @AnnotTwoArgAllDefault(name = hi1, name2 = hi2), @NullStatus(nullable = []), metaBinary:@Uninterruptible, toBinary:@Uninterruptible]

~~~~~
//##15. annotation key value more than one ararays
[$ConcurnasMetaVersion$:, copy:, copy:, defaultFieldInit$:, equals:@NullStatus(nullable = []), fromBinary:@Uninterruptible, getGlobalDependancies$:, hashCode:@NullStatus(nullable = []), m1:@AnnotTwoArgOneDefault(name = firstname, name2 = 999), @AnnotTwoArgAllDefault(name = hi1, name2 = hi2), @AnotTakesIntArrayx2(theArg = [1 2 3], theArg2 = [2 4 6]), @NullStatus(nullable = []), metaBinary:@Uninterruptible, toBinary:@Uninterruptible]

~~~~~
//##16. annotation class argument
[$ConcurnasMetaVersion$:, copy:, copy:, defaultFieldInit$:, equals:@NullStatus(nullable = []), fromBinary:@Uninterruptible, getGlobalDependancies$:, hashCode:@NullStatus(nullable = []), m1:@TakesClass(theArg = class java.lang.String), @NullStatus(nullable = []), m2:@TakesClass(theArg = int), @NullStatus(nullable = []), metaBinary:@Uninterruptible, toBinary:@Uninterruptible]

~~~~~
//##17. annotation enum argument
[$ConcurnasMetaVersion$:, copy:, copy:, defaultFieldInit$:, equals:@NullStatus(nullable = []), fromBinary:@Uninterruptible, getGlobalDependancies$:, hashCode:@NullStatus(nullable = []), m1:@TakesEnum(theArg = ONE), @NullStatus(nullable = []), metaBinary:@Uninterruptible, toBinary:@Uninterruptible]

~~~~~
//##18. annotation nested annotation argument
[$ConcurnasMetaVersion$:, copy:, copy:, defaultFieldInit$:, equals:@NullStatus(nullable = []), fromBinary:@Uninterruptible, getGlobalDependancies$:, hashCode:@NullStatus(nullable = []), m0:@TakesAnnotation(theArg = @TakesEnum(theArg = ONE)), @NullStatus(nullable = []), m1:@TakesAnnotation(theArg = @TakesEnum(theArg = ONE)), @NullStatus(nullable = []), metaBinary:@Uninterruptible, toBinary:@Uninterruptible]
