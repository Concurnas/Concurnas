//##0.0.0.01 bug with labels when wrapping loops 
...
[[0 -8], [0 888], [2 0], [0 888], [3 0], [0 888], 6, 3]

~~~~~
//##99.2 - nice and basic fin call 2
[[0 456], [0 456], [0 7], [0 7], [0 7], [0 7], 6, 0]

~~~~~
//##99.2 - nice and basic fin call 3
[[0 -8], [0 100], [2 100], [0 100], [3 100], [0 100], 6, 99]

~~~~~
//##99.2 - nice and basic fin call 4
[[0 -8], [0 888], [2 100], [0 888], [3 100], [0 888], 6, 99]

~~~~~
//##99.2 - nice and basic fin call 5
[[0 456], [0 456], [0 7], [0 7], [0 7], [0 7], 6, 99]
...
[[0 -8], [0 7], [0 -8], [0 7], [3 100], [0 7], 6, 99]

~~~~~
//##0.0.1 double reboot - 1c no fin
[[0 -8], [0 7], [0 -8], [0 7], [3 0], [0 7], 0, 0]
...
~~~~~
//##0.1 reboot - simple 
[[1 100], [0 100], [2 0], [0 100], [3 100], [0 100], 6]

~~~~~
//##0.1 reboot - simple 2
[[1 100], [0 100], [2 100], [0 100], [3 100], [0 100], 6]

~~~~~
//##0.1 reboot - simple 3
[[1 100], [0 888], [2 100], [0 888], [3 100], [0 888], 6]
...
[1, 1, 2, 2, 3, 3, 78, 3, 100, 3, 100, 3, 4, 4, 78, 4]
...
[40, 40, 10, 40, 20, 40, 10, 40, 40, 40, 10, 40, 30, 40, 10, 40]

~~~~~
//##7. tag if statement carryOn - supress
[40, 40, 11, 40, 21, 40, 11, 40, 40, 40, 11, 40, 31, 40, 11, 40]
...
[90, 40, 11, 40, 90, 40, 11, 40, 90, 40, 11, 40, 90, 40, 11, 40]
[40, 40, 11, 40, 21, 40, 11, 40, 40, 40, 11, 40, 30, 40, 11, 40]
...
[96, 40, 30, 40, 1, 40, 30, 40]

~~~~~
//##18. nested if - c - stuff after - another variant2
[96, 40, 30, 40, 3, 40, 30, 40]
...
[[1 1], [0 888], [2 32], [0 888], [3 32], [0 888], 6]
...
[10, 80, 10, 80, 10, 80, 10, 80, 4, 2, 4, 2]

~~~~~
//##33.2 nest simple - early ret in catch, catch ends in exception
[10, 80, 10, 80, 10, 80, 10, 80, 4, 0, 4, 2]
...
~~~~~
//##54. extra - defo excep case
[[0 -8 0], [0 888 0], [2 999 0], [0 888 0], [2 999 0], [0 888 0]]
[[0 -8 0], [0 888 0], [2 -8 0], [0 888 0], [2 -8 0], [0 888 0]]
12

~~~~~
//##55. extra - coalesce properly
ok

~~~~~
//##55. extra - coalesce properly b
ok::1

~~~~~
//##55. extra - coalesce properly c breaking
ok::1

~~~~~
//##55. extra - coalesce properly d cont
ok::1

~~~~~
//##56. extra - top level exceptions
77: [1, 1] :: 1

~~~~~
//##57. extra - exceptions via constructor
99

~~~~~
//##58. extra - ends in break
9: [1, 2] :: 2

~~~~~
//##58.b extra - ends in continue
9: [1, 2] :: 2
...
~~~~~
//##60. nested inner function
9: [1, 2] :: 2

~~~~~
//##61. buigfix return was incorrectly tagged
fine

~~~~~
//##62. bugfix on for loop return label
fine

~~~~~
//##63. another while with label problems
77: [0, 1] :: 2
