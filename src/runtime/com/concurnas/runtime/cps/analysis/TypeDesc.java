...
import static com.concurnas.runtime.cps.Constants.D_STRING;
...
public class TypeDesc {
    ...
    public static boolean isDoubleWord(String desc) {
    ...
    public static String commonSuperType(String oa, String ob) {
       // try {
            ...
            String lub;
            try{
            	lub = Detector.getDetector().getCommonSuperClass(getInternalName(oa), getInternalName(ob));
            }
            catch(Exception e){
            	lub = "java/lang/Object";
            }
