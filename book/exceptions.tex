...
\draw[anchor=north west,text width=8cm] (9.2cm,10.8cm) node {\begin{footnotesize}"And now we're stuck on rewind\\
	Let's follow the cops back home\\
	Follow the cops back home\\
	Lets follow the cops back home\\
	And rob their houses"\\
	\begin{flushright} - Follow the Cops Back Home from Meds by Placebo (2006).\end{flushright}\end{footnotesize}};
\end{tikzpicture}
