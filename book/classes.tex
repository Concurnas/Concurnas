...
\draw[anchor=north west,text width=8cm] (9.2cm,10.8cm) node {\begin{footnotesize}"She says shes an 80s baby\\
	She goes for the bad boy type\\
	She says shes an 80s baby\\
	In the club she dance all night"\\
	\begin{flushright}- All Night from Synthetic Love LP by Trevor Something (2013).\end{flushright}\end{footnotesize}};
\end{tikzpicture}
