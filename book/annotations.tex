...
\draw[anchor=north west,text width=8cm] (9.2cm,10.8cm) node {\begin{footnotesize}"The Rhyming Rabbit was sitting with his family in a grassy field.\\
	All the other rabbits were eating the grass but the Rhyming Rabbit was making up a poem about it"\\
	\begin{flushright}- Donaldson, Julia and Monks, Lydia. (2011). The Rhyming Rabbit. Macmillan Publishers Limited.\end{flushright}\end{footnotesize}};
\end{tikzpicture}
