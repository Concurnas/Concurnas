...
\draw[anchor=north west,text width=8cm] (9.2cm,10.8cm) node {\begin{footnotesize}"Time to wake up\\
	Refill new destiny\\
	Through this"\\
	\begin{flushright}- The Whitest of Lies from Prototype by NeuroWulf (2005).\end{flushright}\end{footnotesize}};
\end{tikzpicture}
