...
\begin{enumerate}
	\item Setup a project using an IDE - currently Concurnas has support for Atom, Sublime Text and planned support for VC Code.
...
\begin{itemize}
	...
	\item Jupyter notebooks. Concurnas integrates well with Jupyter.
\end{itemize}
