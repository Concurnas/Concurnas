...
rem echo "%_JAVACMD%" %_JAVA_OPTS% %_PROPS% -cp "%_TOOL_CLASSPATH%" com.concurnas.conc.ConcWrapper conc  %*
"%_JAVACMD%" %_JAVA_OPTS% %_PROPS% -cp "%_TOOL_CLASSPATH%" com.concurnas.conc.ConcWrapper conc  %*
goto end
